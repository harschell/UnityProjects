...
public class Sensor1 : MonoBehaviour
{
	...
	public GameObject light_cylinder_from_s3;
...
//				Debug.Log(active);
		...
		if (light_cylinder_from_s3.renderer.enabled)
		{
			if (!active)
			{
				if (toActivate != null)
...
//			toActivate.GetComponent<Activation> ().deactivate ();
			GetComponent<Level1_activation_torch1> ().deactivate ();
		}
		active = false;
	}
}